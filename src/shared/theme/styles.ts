...
export const S: Record<string, CSSProperties> = {
  ...
  obCard: { padding: spacing.lg, background: colors.surface, border: `2px solid ${colors.surfaceHover}`, borderRadius: radii.xl, color: colors.text, cursor: 'pointer', textAlign: 'left', position: 'relative' },
  obCardActive: { border: `2px solid ${colors.primary}`, background: 'rgba(255,59,48,0.1)' },
  obCardHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 },
  obCardName: { fontSize: typography.sizes['3xl'], fontWeight: typography.weights.black },
  obCardDays: { fontSize: typography.sizes.base, color: colors.textTertiary, fontWeight: typography.weights.bold },
  obCardDesc: { fontSize: typography.sizes.lg, color: colors.textSecondary, lineHeight: 1.4 },
  obBadge: { display: 'inline-block', padding: `2px ${spacing.sm}px`, background: colors.primarySurface, border: `1px solid ${colors.primaryBorder}`, borderRadius: radii.sm, color: colors.primary, fontSize: typography.sizes.xs, fontWeight: typography.weights.black, letterSpacing: '0.05em', marginLeft: spacing.sm },
  obWeightList: { display: 'flex', flexDirection: 'column', gap: spacing.md, marginBottom: spacing.lg, textAlign: 'left', width: '100%' },
  obWeightRow: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: spacing.md },
  obWeightLabel: { fontSize: typography.sizes.xl, fontWeight: typography.weights.bold, flex: 1 },
  obWeightInputWrap: { display: 'flex', alignItems: 'center', gap: 6 },
  obWeightInput: { width: 80, padding: `${spacing.sm}px ${spacing.md}px`, background: 'rgba(255,255,255,0.05)', border: '2px solid rgba(255,255,255,0.1)', borderRadius: radii.lg, color: colors.text, fontSize: typography.sizes['3xl'], textAlign: 'center', outline: 'none' },
  obWeightUnit: { fontSize: typography.sizes.lg, color: colors.textTertiary, fontWeight: typography.weights.bold },
  obDisclaimer: { fontSize: typography.sizes.sm, color: colors.textTertiary, lineHeight: 1.5, marginTop: spacing.lg, marginBottom: spacing.md },

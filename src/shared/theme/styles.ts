...
export const S: Record<string, CSSProperties> = {
  ...
  exCard: { padding: spacing.lg, borderRadius: radii.lg, background: colors.surface, border: '1px solid #222', transition: 'all 0.2s' },
  exDone: { background: colors.successSurface, border: `1px solid ${colors.successBorder}` },
  exCardCompleted: { opacity: 0.5, paddingTop: spacing.md, paddingBottom: spacing.md, minHeight: 84 },
  ...
  exHeader: { display: 'flex', justifyContent: 'space-between', gap: spacing.md, marginBottom: spacing.sm },
  ...
  exName: { fontSize: typography.sizes['2xl'], fontWeight: typography.weights.bold, margin: 0 },
  exNameDone: { fontSize: typography.sizes.xl, fontWeight: typography.weights.bold, margin: 0, textDecoration: 'line-through' },
  exMeta: { fontSize: typography.sizes.sm, color: colors.textSecondary, marginTop: 3 },
  exSecondaryActions: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: spacing.sm },
  ...
  // Stats grid
  stats: { display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: spacing.sm, marginTop: spacing.md, marginBottom: spacing.md },
  ...
  ghostSection: { marginBottom: spacing.md, padding: spacing.sm, borderRadius: radii.md, border: `1px solid ${colors.surfaceHover}`, background: 'rgba(255,255,255,0.015)' },
  ghostSummary: { fontSize: typography.sizes.sm, color: colors.textSecondary, marginBottom: spacing.sm },
  ghostBars: { display: 'flex', flexDirection: 'column', gap: 6 },
  ghostBarRow: { display: 'grid', gridTemplateColumns: '42px 1fr', alignItems: 'center', gap: spacing.sm },
  ghostBarLabel: { fontSize: typography.sizes.xs, color: colors.textSecondary, fontWeight: typography.weights.bold },
  ghostTrack: { width: '100%', height: 8, borderRadius: 999, background: 'rgba(255,255,255,0.08)', overflow: 'hidden' },
  ghostFillYou: { height: '100%', borderRadius: 999, background: colors.primaryGradient },
  ghostFillGhost: { height: '100%', borderRadius: 999, background: colors.textSecondary },
  completedTitleRow: { display: 'flex', alignItems: 'center', gap: spacing.sm, color: colors.success, marginBottom: 4 },
  completedSummaryRow: { fontSize: typography.sizes.base, color: colors.textSecondary, marginBottom: 4 },
  completedProgressionRow: { fontSize: typography.sizes.base, color: colors.success, fontWeight: typography.weights.bold },
